      ...
      <tr>
         <td>
            ...
            if($pedido->rowCount() == 1){
              ...
              $sql = MySql::conectar()->prepare("  
                  INSERT INTO tb_pedido(cliente,id_funcionario,status,clienteCad,total) VALUES ('Não informado',?,'C',0,0);
                  ");
              ...
              $p = MySql::conectar()->prepare("  
                  INSERT INTO tb_aux_pedido(id_pedido,id_cliente) VALUES (?,0);
                  ");
                     ...
                     <tr>
                        <td>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-8 inputGroupContainer">
                              <input placeholder="<?php echo $pedido['cliente'];?>" name="nome" class="form-control client" type="text"></div>
                           </div>
                        <td>
                           <div class="form-group">
...
<div class="w100 left" style="margin-top: 50px;">
   ...
   <?php if($total != 0):?>
     ...
     <button type="button" class="btn" onclick="gerarPedido(<?php echo $pedido['idpedido'];?>)">Gerar Pedido</button>
     <?php endif;?>
  ...
  function gerarPedido(idpedido){
    var cliente = $('.client').val();
      $.ajax({
        ...
        method:'post',
        dataType: 'json',
        data: {'idpedido':idpedido,'type':0,'cliente':cliente}
      }).done(function(data){
